---
title: "Overview"
description: "Base URLs, authentication, rate limits, idempotency, and error handling."
---

## Tenant API Overview

The Tenant API allows businesses to search offers, create and manage orders, issue tickets, and configure webhooks programmatically.
...
<CardGroup cols={2}>
    ...
    <Card title="Live URL" icon="bolt">
        `https://live.travelbase.ai`

        Production environment for real-world operations.
    </Card>
</CardGroup>
...
<Card title="Default Rate Limit" icon="gauge-high">
